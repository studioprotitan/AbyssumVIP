...
// ============================================================
//
// SCOPE: MINIMAL. Do not expand until Test Loop A confirms live.
// One chunk. Manifest-driven. State reflected in SystemIntegrityPanel.
// No random placement. No hardcoded paths. No suppositional logic.
//
// AUTHORITY CHAIN:
...
import { MOAI }        from '../../lib/moai'; // Adjusted path
import { SentinelLog } from '../../lib/SentinelLogger'; // Adjusted path
