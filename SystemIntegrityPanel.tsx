 ...
 * Accepts live SystemReport prop for MOAI Bridge integration.
 */
...
/**
 * Default state used if no live report is provided during boot.
 */
  ...
  return (
    <div className="w-full select-none">
      <p className="font-mono text-[9px] tracking-[0.25em] text-[#4a4040] uppercase mb-[10px]">
        SYSTEM INTEGRITY {report ? '• LIVE' : '• BOOT'}
      </p>
