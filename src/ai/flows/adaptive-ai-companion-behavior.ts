...
// 1. Type Definitions for Pseudo-Memory and Behavior Actions
...
export type AdaptiveAICompanionBehaviorInput = z.infer<typeof PseudoMemorySnapshotSchema>;
...
// 3. Behavior Repository (from provided behaviorRepo.ts, embedded for LLM context)
...
const adaptiveAICompanionPrompt = ai.definePrompt({
  ...
  output: { schema: z.array(BehaviorActionSchema) }, // The output is an array of BehaviorAction
